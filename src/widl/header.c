...
static void write_forward(FILE *header, type_t *iface)
{
  ...
  fprintf(header, "\n" );
#endif
  fprintf(header, "#endif \t/* __%s_FWD_DEFINED__ */\n\n\n", iface->c_name);
}
...
void write_header(const statement_list_t *stmts)
{
  ...
  fprintf(header, "/*** Autogenerated by WMIDL %s from %s - Do not edit ***/\n\n\n", PACKAGE_VERSION, input_name);

  fprintf(header, "/* this ALWAYS GENERATED file contains the definitions for the interfaces */\n");
  ...
  fprintf(header, "#endif /*COM_NO_WINDOWS_H*/\n\n");
  ...
  fprintf(header, "/* header files for imported files */\n");
